...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            ...
            InlineKeyboardButton('💠 CHΛИИΞL 💠', url='https://t.me/technicalaks1'),
            InlineKeyboardButton('💠 UᎮDΛTΞS 💠', url='https://t.me/Imdb_updates')
            ],[      
        ...
        buttons= [[
            InlineKeyboardButton('♥️ Join ♥️', url='https://t.me/HbBackup')
            ],[
            InlineKeyboardButton('🏠 𝗛𝗼𝗺𝗲 🏠', callback_data='start'),
